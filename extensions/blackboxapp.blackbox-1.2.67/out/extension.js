...
function activate(_) {
	...
	if (installed_date){
		if (
			(installed_date > inline_sep1_update && installed_date < inline_nov20_update)
			|| (installed_date > date_march_13)
		){
  ...
  <body style="margin:0px;padding:0px;overflow:hidden">
	...
	const bugReport = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Left, 1);
