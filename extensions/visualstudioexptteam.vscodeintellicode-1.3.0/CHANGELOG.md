...
## [1.3.0]
- Bug fix for Java support when model is incomplete. [redhat-developer/vscode-java#2966](https://github.com/redhat-developer/vscode-java/issues/2966)
- Update dependencies
- Deprecate non-pylance python support
- Deprecate service model in favor of bundled models
